...
<html lang="cn">
	<head>
        ...
        <link rel="stylesheet" href="/theme/cool/index/css/meanmenu.css">
		<link rel="stylesheet" href="/theme/cool/index/css/slick.min.css">
		<link rel="stylesheet" href="/theme/cool/index/css/style.css">
		<link rel="stylesheet" href="/theme/cool/index/responsive.css">
...
{*								<li class="nav-item"><a href="#purchase" class="nav-link">价格</a></li>*}
		...
		<footer class="footer-area bg-f7fafd">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 col-sm-6" id="support">
						<div class="single-footer-widget">
							<h3>支持</h3>
							<ul class="list">
								<li><a href="/">联系我们</a></li>
					...
					<div class="col-lg-12 col-md-12">
						<div class="copyright-area">
							<p>© Sspanel&nbsp;•&nbsp;<span id="copyright">Powered by <a href="/staff">SSPANEL</a>&nbsp;•&nbsp;Theme by <a href="https://t.me/Cool_WuKong" target="blank">WuKong</a></span></p>
						</div>
					</div>
				</div>
			</div>

			<img src="/theme/cool/index/img/map.png" class="map" alt="map" style="max-height: 100%">
			<div class="shape1"><img src="/theme/cool/index/img/shape1.png" alt="shape"></div>
			<div class="shape8 rotateme"><img src="/theme/cool/index/img/shape2.svg" alt="shape"></div>
		</footer>
		<!-- End Footer Area -->
		...
		<script src="/theme/cool/index/js/appear.min.js"></script>
		<script src="/theme/cool/index/js/odometer.min.js"></script>
        <script src="/theme/cool/index/js/slick.min.js"></script>
        <script src="/theme/cool/index/js/headroom.js"></script>
        <script src="/theme/cool/index/js/isotope.pkgd.min.js"></script>
